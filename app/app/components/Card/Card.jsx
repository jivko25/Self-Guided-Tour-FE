  ...
  return (
    <>
      {testimonial ? (
        ...
        <div
          className={`w-[176px] h-[224px] tablet:w-[282px] tablet:h-[492px] web:w-[330px] webl:w-[430px] web:h-[522px] bg-[#FAFAFA] border border-[#D1D0D8] rounded-[5px] tablet:rounded-[15px] ${classes}`}
          onClick={onclick}
        >
