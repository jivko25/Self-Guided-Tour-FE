...
export default function Footer() {
  ...
  const specialPages = ["/sign-in", "/create-account", "/create", "/admin" , "/forgot-password" ,"/reset-password","/success"];
  ...
  return (
    <div className={`hidden web:py-[0%] tablet:flex tablet:py-[10%] flex-col items-center justify-center w-full min-h-[474px] web:px-[20%] tablet:px-[3%] ${footerColors } ${hiddenFooter}`}>
      <h1 className="flex w-full max-w-[1336px] text-center text-[31px] font-medium   mb-[55px] mt-[35px]">
      <Image
      ...
      <section className="flex w-full max-w-[1336px] web:gap-[100px] tablet:gap-[30px]">
        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="flex flex-col gap-[10px]">
            <Link href="/explore?page=1&search=sofia" className="text-base font-normal   cursor-pointer hover:underline">
              Sofia
            </Link>
            <Link href="/explore?page=1&search=plovdiv" className="text-base font-normal   cursor-pointer hover:underline">
              Plovdiv
            </Link>
            <Link href="/explore?page=1&search=veliko%20tarnovo" className="text-base font-normal   cursor-pointer hover:underline">
              Veliko Tarnovo
            </Link>
            <Link href="/explore?page=1&search=ruse" className="text-base font-normal   cursor-pointer hover:underline">
              Ruse
            </Link>
            <Link href="/explore?page=1&search=burgas" className="text-base font-normal   cursor-pointer hover:underline">
              Burgas
            </Link>
          </div>
        </div>
        <div className="flex flex-col flex-1">
          <div className="flex flex-col gap-[10px]">
            <Link href="" className="text-base font-normal   cursor-pointer hover:underline">
              Search
            </Link>
            <Link href="" className="text-base font-normal   cursor-pointer hover:underline">
              Account
            </Link>
            <Link href="/create" className="text-base font-normal   cursor-pointer hover:underline">
              Create Tour
            </Link>
            <Link href="" className="text-base font-normal   cursor-pointer hover:underline">
              My Tours
        ...
        <div className="flex flex-col flex-1">
          <p className="text-base font-medium   mb-[20px]">
            Stay in Touch
          </p>
