...
const Modal = ({ title, description, onClose, onConfirm }) => {
  return createPortal(
    <>
      <div className="z-20 fixed top-0 left-0  w-[100%] h-[100vh] bg-[#000000bf]" />
      <motion.dialog
        variants={{
        ...
        exit="hidden"
        open
        className="z-20 flex flex-col grid-6 text-center bg-[#FAFAFA] web:w-[582px] tablet:w-[450px] w-[282px] h-[440px] tablet:h-[500px]  rounded-md"
      >
